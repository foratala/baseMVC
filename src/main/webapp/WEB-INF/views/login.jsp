...
<div class="row">
    <div class="col-md-6 col-md-offset-2">
        ...
        <form:form id="loginForm" method="post" action="${rootURL}auth/login_check?targetUrl=${targetUrl}" modelAttribute="user"
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <div class="checkbox">
                        <label><input type="checkbox" name="remember-me" placeholder="RememberMe">Remember
                            me</label>
                    </div>
                </div>
            </div>
